...
{id:'boots',name:'丈夫な旅靴',icon:'🥾',kind:'cloth',w:2,h:1,weight:.7,parent:'main',x:6,y:0,travel:{footwearFactor:1.08}},
...
{id:'petfood',name:'餌袋',icon:'◫',kind:'food',w:2,h:1,weight:.8,parent:'pet',x:0,y:0,companionFeed:{remove:true}}];
